...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="CSS files/update-data-page-1.css" type="text/css">
            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        <button class='edit' onclick="document.location.href='update-data-page-2.php?id=<?= $row['id']; ?>'">Edit</button>
                        <?php
                        ;
                    }
                    echo "</table>";
